...
/***/ "./glTF/2.0/Extensions/KHR_image_ktx2.ts":
/*!***********************************************!*\
  !*** ./glTF/2.0/Extensions/KHR_image_ktx2.ts ***!
  \***********************************************/
/*! exports provided: KHR_image_ktx2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KHR_image_ktx2", function() { return KHR_image_ktx2; });
/* harmony import */ var _glTFLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../glTFLoader */ "./glTF/2.0/glTFLoader.ts");

var NAME = "KHR_image_ktx2";
/**
 * TODO
 */
var KHR_image_ktx2 = /** @class */ (function () {
    /** @hidden */
    function KHR_image_ktx2(loader) {
        /** The name of this extension. */
        this.name = NAME;
        /** Defines whether this extension is enabled. */
        this.enabled = true;
    ...
    /** @hidden */
    KHR_image_ktx2.prototype.dispose = function () {
        delete this._loader;
    };
    return KHR_image_ktx2;
}());

_glTFLoader__WEBPACK_IMPORTED_MODULE_0__["GLTFLoader"].RegisterExtension(NAME, function (loader) { return new KHR_image_ktx2(loader); });
...
/***/ "./glTF/2.0/Extensions/KHR_texture_cttf.ts":
/*!*************************************************!*\
  !*** ./glTF/2.0/Extensions/KHR_texture_cttf.ts ***!
  \*************************************************/
/*! exports provided: KHR_texture_cttf */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KHR_texture_cttf", function() { return KHR_texture_cttf; });
/* harmony import */ var _glTFLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../glTFLoader */ "./glTF/2.0/glTFLoader.ts");

var NAME = "KHR_texture_cttf";
/**
 * TODO
 */
var KHR_texture_cttf = /** @class */ (function () {
    /** @hidden */
    function KHR_texture_cttf(loader) {
        /** The name of this extension. */
        this.name = NAME;
        /** Defines whether this extension is enabled. */
        this.enabled = true;
    ...
    /** @hidden */
    KHR_texture_cttf.prototype.dispose = function () {
        delete this._loader;
    };
    KHR_texture_cttf.prototype.loadTextureAsync = function (context, texture, assign) {
        var _this = this;
...
_glTFLoader__WEBPACK_IMPORTED_MODULE_0__["GLTFLoader"].RegisterExtension(NAME, function (loader) { return new KHR_texture_cttf(loader); });
...
/*!**************************************!*\
  !*** ./glTF/2.0/Extensions/index.ts ***!
  \**************************************/
/*! exports provided: EXT_lights_image_based, KHR_draco_mesh_compression, KHR_image_ktx2, KHR_lights, KHR_materials_pbrSpecularGlossiness, KHR_materials_unlit, KHR_texture_cttf, KHR_texture_transform, MSFT_audio_emitter, MSFT_lod, MSFT_minecraftMesh, MSFT_sRGBFactors, ExtrasAsMetadata */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _KHR_image_ktx2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./KHR_image_ktx2 */ "./glTF/2.0/Extensions/KHR_image_ktx2.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "KHR_image_ktx2", function() { return _KHR_image_ktx2__WEBPACK_IMPORTED_MODULE_2__["KHR_image_ktx2"]; });
...
/* harmony import */ var _KHR_texture_cttf__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./KHR_texture_cttf */ "./glTF/2.0/Extensions/KHR_texture_cttf.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "KHR_texture_cttf", function() { return _KHR_texture_cttf__WEBPACK_IMPORTED_MODULE_6__["KHR_texture_cttf"]; });

/* harmony import */ var _KHR_texture_transform__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./KHR_texture_transform */ "./glTF/2.0/Extensions/KHR_texture_transform.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "KHR_texture_transform", function() { return _KHR_texture_transform__WEBPACK_IMPORTED_MODULE_7__["KHR_texture_transform"]; });

/* harmony import */ var _MSFT_audio_emitter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./MSFT_audio_emitter */ "./glTF/2.0/Extensions/MSFT_audio_emitter.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MSFT_audio_emitter", function() { return _MSFT_audio_emitter__WEBPACK_IMPORTED_MODULE_8__["MSFT_audio_emitter"]; });

/* harmony import */ var _MSFT_lod__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./MSFT_lod */ "./glTF/2.0/Extensions/MSFT_lod.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MSFT_lod", function() { return _MSFT_lod__WEBPACK_IMPORTED_MODULE_9__["MSFT_lod"]; });

/* harmony import */ var _MSFT_minecraftMesh__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./MSFT_minecraftMesh */ "./glTF/2.0/Extensions/MSFT_minecraftMesh.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MSFT_minecraftMesh", function() { return _MSFT_minecraftMesh__WEBPACK_IMPORTED_MODULE_10__["MSFT_minecraftMesh"]; });

/* harmony import */ var _MSFT_sRGBFactors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./MSFT_sRGBFactors */ "./glTF/2.0/Extensions/MSFT_sRGBFactors.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MSFT_sRGBFactors", function() { return _MSFT_sRGBFactors__WEBPACK_IMPORTED_MODULE_11__["MSFT_sRGBFactors"]; });

/* harmony import */ var _ExtrasAsMetadata__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ExtrasAsMetadata */ "./glTF/2.0/Extensions/ExtrasAsMetadata.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ExtrasAsMetadata", function() { return _ExtrasAsMetadata__WEBPACK_IMPORTED_MODULE_12__["ExtrasAsMetadata"]; });
...
var GLTFLoader = /** @class */ (function () {
    ...
    GLTFLoader.prototype._loadTextureAsync = function (context, texture, assign) {
        ...
        var samplerData = this.loadSampler("/samplers/" + sampler.index, sampler);
        var image = ArrayItem.Get(context + "/source", this._gltf.images, texture.source);
        var promise = this.createTextureAsync(context, samplerData, image, assign);
        this.logClose();
        return promise;
    };
    GLTFLoader.prototype.createTextureAsync = function (context, samplerData, image, assign) {
        var _this = this;
        if (assign === void 0) { assign = function () { }; }
        var promises = new Array();
        ...
        promises.push(this.loadImageAsync("/images/" + image.index, image).then(function (data) {
            ...
            babylonTexture.updateURL(dataUrl, data.slice().buffer);
        }));
    ...
    GLTFLoader.prototype.loadSampler = function (context, sampler) {
        if (!sampler._data) {
            sampler._data = {
    ...
    GLTFLoader.prototype._extensionsLoadTextureAsync = function (context, texture, assign) {
        return this._applyExtensions(texture, "loadTexture", function (extension) { return extension.loadTextureAsync && extension.loadTextureAsync(context, texture, assign); });
    };
...
/*!***************************!*\
  !*** ./glTF/2.0/index.ts ***!
  \***************************/
/*! exports provided: ArrayItem, GLTFLoader, EXT_lights_image_based, KHR_draco_mesh_compression, KHR_image_ktx2, KHR_lights, KHR_materials_pbrSpecularGlossiness, KHR_materials_unlit, KHR_texture_cttf, KHR_texture_transform, MSFT_audio_emitter, MSFT_lod, MSFT_minecraftMesh, MSFT_sRGBFactors, ExtrasAsMetadata */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "KHR_image_ktx2", function() { return _Extensions__WEBPACK_IMPORTED_MODULE_1__["KHR_image_ktx2"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "KHR_texture_cttf", function() { return _Extensions__WEBPACK_IMPORTED_MODULE_1__["KHR_texture_cttf"]; });
